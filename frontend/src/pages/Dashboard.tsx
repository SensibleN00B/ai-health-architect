...
import { stats, type StatsSummary } from '../services/api';
...
const Dashboard: React.FC = () => {
  const { user } = useUser();
  const [dailyStats, setDailyStats] = useState<StatsSummary | null>(null);
  const [history, setHistory] = useState<StatsSummary[]>([]);
